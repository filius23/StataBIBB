...
knitr::include_graphics("./pics/01_Stata8_Datensatz_pfeil.PNG")
```
...
knitr::include_graphics("./pics/01_Stata8_Datensatz_suche.PNG")
```
...
::: {#hello .greeting .message style="padding: 1em; margin: 1em 0; color: #2C3E50; background-color: #FDEBD0; border: 3px #FAD7A0;"}
  **Update zu BIBB/BAuA-Erwerbstätigenbefragung**
:::
...
knitr::include_graphics("./pics/01_Codebuch.PNG")
```
