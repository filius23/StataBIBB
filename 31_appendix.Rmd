...
tribble(
    ~"Variablenname", ~"Beschreibung", ~"Details",
	 "id" ,		"Befragten-Identifikationsnummer", "",
	 "x1" ,		"Geschlecht", "0 = Frau, 1 = Mann, -9 keine Angabe",
	 "x2" ,		"Haustiere?", "0 = nein, 1 =  ja, -9  keine Angabe, -1 Datenfehler",
	 "x3" ,		"Frühaufsteher?", "0 = nein, 1 =  ja, -9  keine Angabe, -1 Datenfehler",
