--- 
title: "Stata Fortbildung mit Statistikwissen"
subtitle: "Stata @ BIBB"
author: "Andreas Filser"
date: "`r Sys.Date()`"
output: 
  pdf_document
header-includes: \usepackage{xcolor,mdframed}
---
...
knitr::include_graphics("../StataBIBB1/pics/09_mplot4.png")
```
...
knitr::include_graphics("../StataBIBB1/pics/01_Stata_intro1.png")
```
...
knitr::include_graphics("../StataBIBB1/pics/01_Stata3_calc.png")
```
...
knitr::include_graphics("../StataBIBB1/pics/01_Stata_open_DOedit.png")
```
Es öffnet sich ein neues Fenster:
```{r screenshot_dof_opened, echo = F,out.width = "90%",fig.height= 4.5, fig.align="center"}
knitr::include_graphics("../StataBIBB1/pics/01_Stata5_dofile_editor.png")
```
...
knitr::include_graphics("../StataBIBB1/pics/01_Stata7_dofile_routine.png")
```
...
knitr::include_graphics("../StataBIBB1/pics/01_Stata7_dofile_save.png")
```
...
knitr::include_graphics("../StataBIBB1/pics/01_directory.png")
```
...
knitr::include_graphics("../StataBIBB1/pics/01_Dateipfad_WIN.png")
```
...
knitr::include_graphics("../StataBIBB1/pics/01_Stata_directory.png")
```
...
knitr::include_graphics("../StataBIBB1/pics/01_Stata8_Datensatz.PNG")
```
...
knitr::include_graphics("../StataBIBB1/pics/01_Fragebogen.PNG")
```
...
knitr::include_graphics("../StataBIBB1/pics/01_methodenbericht.PNG")
```
...
knitr::include_graphics("../StataBIBB1/pics/01_Codierung_label.PNG")
```
...
knitr::include_graphics("../StataBIBB1/pics/01_Stata9_bro_Datensatz.png")
```
...
knitr::include_graphics("../StataBIBB1/pics/01_Stata9_bro_Datensatz2.png")
```
...
knitr::include_graphics("../StataBIBB1/pics/01_Stata9_bro_Datensatz2_nol.png")
```
...
knitr::include_graphics("../StataBIBB1/pics/01_Stata8_Datensatz_suche2.PNG")
```
...
knitr::include_graphics("../StataBIBB1/pics/01_import_other.png")
```
...
knitr::include_graphics("../StataBIBB1/pics/01_import_other_copy.png")
```
